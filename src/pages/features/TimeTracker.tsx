...
{/* 
        <motion.div initial="hidden" animate="visible" className="max-w-2xl mx-auto">
          <motion.h2 variants={fadeUp} custom={0} className="text-2xl font-bold text-foreground text-center mb-8">Why Teams Love It</motion.h2>
...
<section className="py-24">
  <div className="container mx-auto px-4">
    ...
    >
      ...
      >
        Why Teams Trust{" "}
        <span className="text-gradient">TeamTrack Time Tracker</span>
      </motion.h2>
    </motion.div>
